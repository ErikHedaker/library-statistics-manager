...
function createStatManagerChildren(errands, lengths) {
    ...
    */
    ...
    return [
        ...
        StatClusterVisitors(`Frequency of primary visitors helped`, ordered.primary),
        StatClusterVisitors(`Frequency of primary visitors helped, in percent`, ordered.primary, mapperValuePercent),
        StatClusterVisitors(`Frequency of all visitors helped`, ordered.visitors),
        StatClusterVisitors(`Frequency of all visitors helped, in percent`, ordered.visitors, mapperValuePercent),
...
function StatClusterVisitors(header, visitors, modifier = (x) => x) {
    const toFreq = (mapper) => {
